...
exports.useComposeRef =
  exports.supportRef =
  exports.supportNodeRef =
  exports.getNodeRef =
  exports.fillRef =
  exports.composeRef =
    void 0;
...
var supportRef = (exports.supportRef = function supportRef(nodeOrComponent) {
  ...
  var type = (0, _reactIs.isMemo)(nodeOrComponent)
  ...
  if (
    ...
    type.$$typeof !== _reactIs.ForwardRef
  ) {
    return false;
  }
  ...
  if (
    ...
    nodeOrComponent.$$typeof !== _reactIs.ForwardRef
  ) {
    return false;
  }
  return true;
...
function isReactElement(node) {
  return (
    /*#__PURE__*/ (0, _react.isValidElement)(node) &&
    !(0, _isFragment.default)(node)
  );
}
