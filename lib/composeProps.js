...
function composeProps(originProps, patchProps, isAll) {
  var composedProps = (0, _objectSpread2.default)(
    (0, _objectSpread2.default)({}, originProps),
    isAll ? patchProps : {},
  );
  Object.keys(patchProps).forEach(function (key) {
    ...
    if (typeof func === 'function') {
      composedProps[key] = function () {
        ...
        return (_originProps$key = originProps[key]) === null ||
          _originProps$key === void 0
          ? void 0
          : _originProps$key.call.apply(
              _originProps$key,
              [originProps].concat(args),
            );
      };
    }
  });
