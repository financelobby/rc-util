...
var _switchScrollingEffect = _interopRequireDefault(
  require('./switchScrollingEffect'),
);
...
var getParent = function getParent(getContainer) {
  ...
  if (getContainer) {
    ...
    if (
      (0, _typeof2.default)(getContainer) === 'object' &&
    ...
    (0, _defineProperty2.default)(
      ...
      function (prevProps) {
        ...
        if (
          ...
          visible !== prevVisible &&
          supportDom &&
          getParent(getContainer) !== _this.scrollLocker.getContainer()
        ) {
    ...
    (0, _defineProperty2.default)(
      ...
      function () {
        ...
        (_this$container = _this.container) === null ||
          ...
          (_this$container = _this$container.parentNode) === null ||
          _this$container === void 0 ||
          _this$container.removeChild(_this.container);
      },
    );
    /**
