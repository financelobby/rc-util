...
function spyElementPrototypes(elementClass, properties) {
  ...
  propNames.forEach(function (propName) {
    var originDescriptor = Object.getOwnPropertyDescriptor(
    ...
    if (typeof spyProp === 'function') {
      ...
      elementClass.prototype[propName] = function spyFunc() {
        ...
        return spyProp.call.apply(
          spyProp,
          [this, originDescriptor].concat(args),
        );
      };
    } else {
      ...
      Object.defineProperty(
        ...
        (0, _objectSpread2.default)(
          (0, _objectSpread2.default)({}, spyProp),
          {},
          {
...
function spyElementPrototype(Element, propName, property) {
  return spyElementPrototypes(
    Element,
    (0, _defineProperty2.default)({}, propName, property),
  );
}
/* eslint-enable */
